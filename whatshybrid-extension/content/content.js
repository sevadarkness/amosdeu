      ...
      timelineItem.innerHTML = `
        ...
        <div class="timeline-card">
          ...
          <div class="card-footer">
            ...
            <button class="copy-btn" onclick="(function(btn){ navigator.clipboard.writeText('${message.replace(/'/g, "\\'")}').then(() => { btn.textContent='✅ Copiado!'; setTimeout(() => btn.textContent='📋 Copiar', 2000); }); })(this)">📋 Copiar</button>
          </div>
        </div>
      `;
